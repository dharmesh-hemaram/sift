...
_how_ multiple responses connect (referred to as "connection points," like a
...
the _same_ endpoint (pagination, polling, staging vs. prod) legitimately
share one pipeline.
...
_different_ endpoints — whether the previous pipeline/result stays visible
